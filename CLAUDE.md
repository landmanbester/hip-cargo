...
- The container image is resolved from `_container_image.py` via dynamic module import
...
- `pyproject.toml` with project configuration and `_container_image.py` for image resolution
