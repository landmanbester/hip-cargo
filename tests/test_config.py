...
class TestGetContainerImage:
    """Test get_container_image reads from entry points."""

    @pytest.mark.unit
    def test_returns_image_for_hip_cargo(self):
        """hip-cargo's own pyproject.toml has a container-image entry point."""
    ...
    def test_returns_none_for_package_without_container(self):
        """Packages without a container-image entry point should return None."""
